  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "size-7 p-0 font-normal aria-selected:opacity-100"),
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeftIcon className="size-3.5" />,
        IconRight: ({ ...props }) => <ChevronRightIcon className="size-3.5" />,
      }}
      locale={fr}
      {...props}
    />
