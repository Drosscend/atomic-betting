import { BetsList } from "@/app/(secure)/team/(team-navbar)/[id]/admin/bets/_components/bet-list";
import { CreateBetButton } from "@/app/(secure)/team/(team-navbar)/[id]/admin/bets/_components/create-bet-button";
