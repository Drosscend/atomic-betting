...
import { RejectedInvitationsManagement } from "@/app/(secure)/team/(team-navbar)/[id]/admin/users/_components/rejected-invitations-management";
...
export default async function UsersPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <RejectedInvitationsManagement team={team} />
