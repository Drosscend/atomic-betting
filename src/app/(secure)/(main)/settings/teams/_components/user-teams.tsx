                ...
                <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                  <DialogTrigger asChild>
                    <Button
                      ...
                      disabled={membership.team.creatorId === user.id || status === "executing"}
                    >
                      {`Quitter l'équipe`}
                    </Button>
                  </DialogTrigger>
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>{`Cette action est irréversible. Vous perdrez l'accès à toutes les données de l'équipe.`}</DialogDescription>
                    </DialogHeader>
                    <Form {...form}>
